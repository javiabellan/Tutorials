...
def conv2d(x, canalesEntrada, canalesSalida, tamañoFiltro=5, strides=1, name="conv"):
	with tf.name_scope(name):
		w = tf.Variable(tf.random_normal([tamañoFiltro, tamañoFiltro, canalesEntrada, canalesSalida]), name="pesos")
		b = tf.Variable(tf.random_normal([canalesSalida]), name="bias"),
...
conv1   = conv2d(entrada, 1, 32, 5, name='conv1')
pool1   = maxpool2d(conv1, k=2, name='pool1')
conv2   = conv2d(pool1, 32, 64, 5, name='conv2')
